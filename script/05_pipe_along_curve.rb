...
n = 9                       # initiate the iteration max
for i in 0..n               # create iteration of i from 0 to n
  # create a series of points based on i value
  x = 5.mm * rand(-1.0..1) # random x from -10.mm to 10.mm
  y = 5.mm * rand(-1.0..1) # random x from -10.mm to 10.mm
  z = i * 10.mm                       # this value create a parabolic curve
